        ...
        <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
                    {["All", "Delayed", "Cold Chain", "At Risk"].map(f => (
                        <button key={f} onClick={() => setFilter(f)}
                            style={{
                                background: filter === f ? "#3b82f620" : "#111827",
                        ...
                        {shipments.map(s => {
                            ...
                            return (
                                <tr key={s.vehicle_id} style={{ borderBottom: "1px solid #1e293b", transition: "background 0.2s" }} className="hover-row">
                                    ...
                                    <td style={{ padding: "14px 16px" }}>
                                        <div style={{
                                            background: isAtRisk ? "#ef444415" : isDelayed ? "#f59e0b15" : "#00ff8715",
                                    ...
                                    <td style={{ padding: "14px 16px" }}>
                                        <button onClick={() => setSelectedShipment(s.vehicle_id)}
                                            style={{ background: "#111827", border: "1px solid #1e293b", color: "#3b82f6", borderRadius: 8, padding: "6px 12px", fontSize: "0.75rem", fontWeight: 600, cursor: "pointer" }}>
                                            Track
                                        </button>
                                    </td>
                                </tr>
            ...
            {activeShipment && (
                <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.6)", zIndex: 1000, display: "flex", justifyContent: "center", alignItems: "center", backdropFilter: "blur(4px)" }}>
                    <div className="slide-in" style={{ background: "#0d1421", border: "1px solid #1e293b", borderRadius: 16, padding: 32, width: 480, maxWidth: "90%" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 0, position: "relative" }}>
                            ...
                            <div style={{ display: "flex", gap: 16, padding: "12px 0", position: "relative", zIndex: 1 }}>
                                <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#00ff87", border: "4px solid #0d1421", flexShrink: 0 }} />
                                <div>
                            ...
                            <div style={{ display: "flex", gap: 16, padding: "12px 0", position: "relative", zIndex: 1 }}>
                                <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#3b82f6", border: "4px solid #0d1421", flexShrink: 0 }} />
                                <div>
                            ...
                            <div style={{ display: "flex", gap: 16, padding: "12px 0", position: "relative", zIndex: 1 }}>
                                <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#1e293b", border: "4px solid #0d1421", flexShrink: 0 }} />
                                <div>
                        ...
                        {activeShipment.temperature_c !== undefined && (
                            <div style={{ marginTop: 24, padding: 16, background: "#111827", borderRadius: 8, borderLeft: "3px solid #00d4ff" }}>
